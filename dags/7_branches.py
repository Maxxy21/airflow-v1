...
def branches_dags():
    ...
    def no_load_task(**kwargs):
        print("No loading today! It's the weekend!")
        return "echo 'No loading today! It's the weekend!'"
    ...
    extract >> [transform_api, transform_db, transform_s3] >> decider_node() >> [load, no_load]
